...
<template>
    <DesktopAppShell title="Favoris" subtitle="Épingle les items que tu veux retrouver rapidement.">
        <div v-if="!pins.length" class="border border-dashed border-[#9c9c9c] bg-white/60 p-6 text-center text-xs text-slate-500">Aucun item épinglé pour l’instant.</div>
